...
static constexpr const char *monsterEncounterEnumNames[] = {
    "INVALID",
    "CULTIST",
    "JAW_WORM",
    "TWO_LOUSE",
...
static constexpr MonsterEncounter weakEnemies[3][5] = {
    ...
    {ME::SPHERIC_GUARDIAN, ME::CHOSEN, ME::SHELL_PARASITE, ME::THREE_BYRDS,
     ME::TWO_THIEVES},
...
static constexpr MonsterEncounter strongEnemies[3][10] = {
    {ME::GREMLIN_GANG, ME::LOTS_OF_SLIMES, ME::RED_SLAVER, ME::EXORDIUM_THUGS,
     ME::EXORDIUM_WILDLIFE, ME::BLUE_SLAVER, ME::LOOTER, ME::LARGE_SLIME,
     ME::THREE_LOUSE, ME::TWO_FUNGI_BEASTS},
    {ME::CHOSEN_AND_BYRDS, ME::SENTRY_AND_SPHERE, ME::CULTIST_AND_CHOSEN,
     ME::THREE_CULTIST, ME::SHELLED_PARASITE_AND_FUNGI, ME::SNECKO,
     ME::SNAKE_PLANT, ME::CENTURION_AND_HEALER},
    {ME::SPIRE_GROWTH, ME::TRANSIENT, ME::FOUR_SHAPES, ME::MAW,
     ME::SPHERE_AND_TWO_SHAPES, ME::JAW_WORM_HORDE, ME::THREE_DARKLINGS,
     ME::WRITHING_MASS}};
static constexpr float strongWeights[3][10] = {
    {1.0f / 16, 1.0f / 16, 1.0f / 16, 1.5f / 16, 1.5f / 16, 2.0f / 16,
     2.0f / 16, 2.0f / 16, 2.0f / 16, 2.0f / 16},
    {2.0f / 29, 2.0f / 29, 3.0f / 29, 3.0f / 29, 3.0f / 29, 4.0f / 29,
     6.0f / 29, 6.0f / 29},
    {
        1.0f / 8,
        1.0f / 8,
...
static constexpr bool isEliteEncounter(MonsterEncounter e) {
  return e == ME::GREMLIN_NOB || e == ME::LAGAVULIN ||
         e == ME::THREE_SENTRIES || e == ME::GREMLIN_LEADER ||
         e == ME::SLAVERS || e == ME::BOOK_OF_STABBING || e == ME::GIANT_HEAD ||
         e == ME::NEMESIS || e == ME::REPTOMANCER;
}
