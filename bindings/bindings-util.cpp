...
namespace sts {
    ...
    std::vector<MonsterEncounter> RLInterface::getImplementedMonsterEncounters()  { 
        std::vector<MonsterEncounter> validEncounters = {MonsterEncounter::GREMLIN_GANG, MonsterEncounter::SMALL_SLIMES, MonsterEncounter::LOTS_OF_SLIMES, MonsterEncounter::LARGE_SLIME, MonsterEncounter::EXORDIUM_THUGS, MonsterEncounter::EXORDIUM_WILDLIFE, MonsterEncounter::AUTOMATON, MonsterEncounter::AWAKENED_ONE, MonsterEncounter::BOOK_OF_STABBING, MonsterEncounter::BLUE_SLAVER, MonsterEncounter::CENTURION_AND_HEALER, MonsterEncounter::COLLECTOR, MonsterEncounter::COLOSSEUM_EVENT_NOBS, MonsterEncounter::COLOSSEUM_EVENT_SLAVERS, MonsterEncounter::CHAMP, MonsterEncounter::CHOSEN, MonsterEncounter::CHOSEN_AND_BYRDS, MonsterEncounter::CULTIST, MonsterEncounter::CULTIST_AND_CHOSEN, MonsterEncounter::DONU_AND_DECA, MonsterEncounter::FOUR_SHAPES, MonsterEncounter::GIANT_HEAD, MonsterEncounter::GREMLIN_LEADER, MonsterEncounter::GREMLIN_NOB, MonsterEncounter::HEXAGHOST, MonsterEncounter::JAW_WORM, MonsterEncounter::JAW_WORM_HORDE, MonsterEncounter::LAGAVULIN, MonsterEncounter::LAGAVULIN_EVENT, MonsterEncounter::LOOTER, MonsterEncounter::MASKED_BANDITS_EVENT, MonsterEncounter::MAW, MonsterEncounter::MUSHROOMS_EVENT, MonsterEncounter::MYSTERIOUS_SPHERE_EVENT, MonsterEncounter::NEMESIS, MonsterEncounter::ORB_WALKER, MonsterEncounter::RED_SLAVER, MonsterEncounter::REPTOMANCER, MonsterEncounter::SENTRY_AND_SPHERE, MonsterEncounter::SHELL_PARASITE, MonsterEncounter::SHELLED_PARASITE_AND_FUNGI, MonsterEncounter::SLAVERS, MonsterEncounter::SNAKE_PLANT, MonsterEncounter::SNECKO, MonsterEncounter::SPIRE_GROWTH, MonsterEncounter::SPHERE_AND_TWO_SHAPES, MonsterEncounter::SPHERIC_GUARDIAN, MonsterEncounter::SLIME_BOSS, MonsterEncounter::THE_GUARDIAN, MonsterEncounter::THE_HEART, MonsterEncounter::THREE_BYRDS, MonsterEncounter::THREE_CULTIST, MonsterEncounter::THREE_DARKLINGS, MonsterEncounter::THREE_LOUSE, MonsterEncounter::THREE_SENTRIES, MonsterEncounter::THREE_SHAPES, MonsterEncounter::TIME_EATER, MonsterEncounter::TRANSIENT, MonsterEncounter::TWO_FUNGI_BEASTS, MonsterEncounter::TWO_LOUSE, MonsterEncounter::TWO_THIEVES, MonsterEncounter::WRITHING_MASS};
